...
public class WisataFragment extends android.support.v4.app.Fragment {
...
//        List<Results> finalResult = new ArrayList<>();
        ...
        urlbaru2.append("&types=" + "zoo|amusement_park|stadium|museum|art_gallery|night_club");
...
//                    Log.d("List Tempat Wisata->", tampung2.get(i).getName());
                }
